...
def make_basic_plots(points, sufix=''):
    ...
    plot_of_x_and_y(points, "day_of_year", "pm1", "date_and_pm1%s.png" % sufix)

    plot_of_x_and_y(points, 'temperature', 'pm1', "temperature_pm1%s.png" % sufix)
    plot_of_x_and_y(points, 'humidity', 'pm1', "humidity_pm1%s.png" % sufix)
    plot_of_x_and_y(points, 'pressure', 'pm1', "pressure_pm1%s.png" % sufix)
